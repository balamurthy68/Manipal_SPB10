...
public class xpathAxesExample {
	...
	WebElement getCurrentPrice,getPercentage;  
		...
		getCurrentPrice = driver.findElement(By.xpath("//a[contains(text(),'Cipla')]/parent::td/following-sibling::td[3]"));
		System.out.println(getCurrentPrice.getText());
		
		//following-sibling
		
		getPercentage = driver.findElement(By.xpath("//a[contains(text(),'Cipla')]/parent::td/following-sibling::td[3]/following-sibling::td"));
